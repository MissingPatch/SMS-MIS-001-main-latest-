        ...
        <div class="main-body">
                ...
                <ul class="navbar-nav">
                  <li class="nav-item active">
                    <a class="nav-link"  href="teacher_profile.php?ID=<?php echo $row["ID"];?>" >Profile <span class="sr-only">(current)</span></a>
                  </li>
                  <li class="nav-item">
              ...
              <div class="card mb-3">
                ...
                <fieldset><legend>Personal Account</legend></fieldset>
                  ...
                  <div class="col-md-6">
									...
									<input type="text" class="form-control" placeholder="" aria-label="First name" value="<?php echo $row["email"];?>" disabled>
								</div>
								<!-- Last name -->
								<div class="col-md-6">
									<label class="form-label">Password:</label>
									<input type="text" class="form-control" placeholder="" aria-label="Last name" value="<?php echo $row["password"];?>" disabled>
								</div>
