                    ...
                    <div class="sparkline13-list shadow-reset">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1><i class="fa big-icon fa-eye"></i> Approve Files</h1>
                            </div>
                        </div>
                                                    ...
                                                    <td><?= $row['document_sent_date']; ?></td>
                                                     <td><?php 
                        	                           if($row['status'] == "Pending"){
                        	                            ...
                        	                            ?></td>
                                                    <td>
                                                    <a href="my_modal" class="btn btn-sm btn-secondary" data-bs-toggle="modal" data-bs-target="#view<?= $row['control_id']; ?>"><i class="bi bi-info-circle"></i></a>
                                                    <a href="config/upload/<?php echo $row['document_name']; ?>"  target="_blank" class="btn btn-sm btn-info"><i class="fa fa-eye"></i></a>
