...
if(isset($_POST['addnew'])){
    ...
    `address`, `province`, `zip`, `last_school_att`, `school_yr`,`year_level`, `school_type`, `status`, `payment_status`,`student_type`,`user_id`)
    VALUES ('$firstname', '$middlename', '$lastname', '$suffix', '$email', '$gender', '$age', '$birth_date', '$course','$major', '$citizenship',
    '$contact_number', '$guardian_info', '$guardian_contact', '$address', '$province', '$zip', '$last_school_att', '$school_yr','$year_level', '$school_type', 
    '$status', '$payment_status','$student_type','$user_id')";
