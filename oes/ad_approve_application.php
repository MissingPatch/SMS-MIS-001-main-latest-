                                    ...
                                    <table class="table table-striped" id="example" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="padding-top: 20px; padding-bottom: 20px;">Payment Status</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT * FROM oes_student_application WHERE status='approved'";
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><strong><?php echo $row['payment_status'];?></td>
                                                    ...
                                                    <td><a href="ad_approve_view.php?ID=<?php echo $row['id'];?>" class="btn btn-success" style="background-color:#07177a;"><i class="bi bi-eye"></i></a></td>
                                                </tr>
                                               <?php }
