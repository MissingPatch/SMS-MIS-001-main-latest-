...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 01, 2023 at 09:30 PM
...
--
ALTER TABLE `mis_activity_logs`
  MODIFY `act_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=301;
...
--
ALTER TABLE `mis_stud_info`
  MODIFY `stud_num` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19019774;
