        ...
        <div class="main-body">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="staffprofile.php?ID=<?php echo $row["ID"];?>">Profile</a>
                    </li>
                    ...
                    <li class="nav-item dropdown dropdown-hover">
                        ...
                        <a class="dropdown-item" href="staffprofile_security.php?ID=<?php echo $row["ID"];?>"><b style="color:#07177a; float:center; width:100px;">Security Setting</b><span class="sr-only">(current)</span></a>
